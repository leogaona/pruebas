<?php
@session_start() ;
$_SESSION['scriptcase']['pdf_ImprimirFacturaMantenimiento']['sc_process_barr'] = true;
require_once('../pdf_ImprimirFacturaMantenimiento/index.php');
unset($_SESSION['scriptcase']['pdf_ImprimirFacturaMantenimiento']['sc_process_barr']);
$ExportCtrl = new pdf_ImprimirFacturaMantenimiento_export_control;
$ExportCtrl->Export_barr();

class pdf_ImprimirFacturaMantenimiento_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_chart_title'] ?> dbo.vw_FacturaImpresion :: Excel</TITLE>
