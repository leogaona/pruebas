...
function ajax_delete_filter(parm)
{
    ...
    $.ajax({
      type: "POST",
      url: "pdf_ImprimirFacturaMantenimiento.php",
...
Table_sv_fil[0] = "nroautorizaciontim";
Table_sv_fil[1] = "idfactura";
Table_sv_fil[2] = "numerofact";
Table_sv_fil[3] = "montototal";
Table_sv_fil[4] = "montofactura";
